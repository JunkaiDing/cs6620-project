// scanner.js — copied unchanged from cs6620/sast/backend/scanner.js
// This is the "scanning brain". The Lambda handler imports scanCode/scanFile/scanDirectory.
// The old Express server.js is intentionally NOT copied — Lambda is triggered by SQS, not HTTP.
    ...
    for (const entry of entries) {
      ...
      if (entry.isDirectory()) {
        ...
        if (extensions.includes(ext)) {
          ...
          if (vulnerabilities.length > 0) results[fullPath] = vulnerabilities;
        }
      }
    }
  };
